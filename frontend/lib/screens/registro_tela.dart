...
class _RegistroTelaState extends State<RegistroTela> {
  ...
  void _enviarEmSegundoPlano(BuildContext context) {
    ...
    Future(() async {
      ...
      final depois = provider.pontos.length;
                  ...
                  return Card(
                    ...
                    child: ListTile(
                          ...
                          MaterialPageRoute(
                            builder: (_) => CarregamentoEdicao(
                              pointData: {
                                ...
                                "abrigos": ponto.abrigos.map((a) => {
                                  "idTipoAbrigo": a.idTipoAbrigo,
                                  "temPatologia": a.temPatologia,
                                  "imgBlobPaths": a.imgBlobPaths,
                                  "imagensPatologiaPaths": a.imagensPatologiaPaths,
                                }).toList(),
                              },
                              index: index,
                            ),
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text('Há Abrigo: ${ponto.abrigos.isEmpty ? 'Não' : 'Sim'}'),
